...
public:
	...
	// ------------------------------------------------------------------------
	void setFloatVec3(const std::string &name, float vector[3]) const
	{
	...
	// ------------------------------------------------------------------------
	void setFloatVec4(const std::string &name, float vector[4]) const
	{
		glUniform4f(glGetUniformLocation(ID, name.c_str()), vector[0], vector[1], vector[2], vector[3]);
	}
